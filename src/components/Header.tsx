...
export function Header() {
  ...
  return (
    <header className="fixed z-50 w-full">
      <div className="container mx-auto px-6 flex items-end">
        {/* Логотип — стоит отдельно, полоска не заходит за него */}
        <a href="/" className="flex items-end gap-2 group shrink-0 py-3 pr-6" onClick={scrollToTop}>
          <img
        ...
        {/* Коричневая полоска с меню — нижний край совпадает с нижним краем логотипа */}
        <div
          className={cn(
            "flex-1 flex items-center justify-between px-8 transition-all duration-500",
            scrolled || mobileMenuOpen
              ? "bg-[#6b3a0f]/95 backdrop-blur-md shadow-lg"
              : "bg-[#6b3a0f]",
          )}
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-white/10 bg-[#6b3a0f]/95 backdrop-blur-md">
