...
const blogPosts: BlogPost[] = [
  {
    id: "1",
    title: "Экологический дизайн",
    excerpt: "Массовое производство показало негативную сторону, вызвав недовольство потребителей. Ответом стала «зелёная» философия, которая заботится о чистоте планеты и гармонии с природой.",
    date: "3 февраля 2026",
    readTime: "6 мин",
    image: "https://cdn.poehali.dev/projects/7ae985cc-6f2a-4264-a699-8608e9d4cbcf/bucket/bc78d60f-f304-4a4f-837f-69572ffdeca6.jpg",
    category: "Философия"
  },
  {
    id: "2",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-wood-medium max-w-2xl mx-auto">
            Полезные статьи о капе, сувели и секретах работы<br />с натуральным деревом
          </p>
        </motion.div>
